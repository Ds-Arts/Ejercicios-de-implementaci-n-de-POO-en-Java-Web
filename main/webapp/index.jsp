...
<body  >
    ...
    <div class="head">
        ...
        <nav class="navbar">
            ...
            <div class="desplegable" >
                ...
                <div class="links">
                    <a href="bolsillo?accion=loginN">nequi</a>
                    <a href="bolsillo?accion=loginD">Daviplata</a>
                </div> 
            </div>
        </nav>
    ...
    <header style="background: url(img/Gray\ &\ White\ Minimalist\ Inspirational\ Quote\ Instagram\ Post.png) no-repeat center;
    width: 100%;
    ...
    class="content header">
            ...
            <div class="btn-home">
                <a href="Vista14.html" class="btn">ver más...</a>
            </div>
    </header>
    ...
    <section class="content sau">
        ...
        <div class="btn-home">
            <a href="Vista14.html" class="btn">Unete a nosotros</a>
        </div>
    </section>
</body>
</html>